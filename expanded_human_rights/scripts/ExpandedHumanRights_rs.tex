\section{Expanded Human Rights
Framework}\label{expanded-human-rights-framework}
...
\tightlist
\item
  \textbf{Hardware}: Community-owned Raspberry Pi nodes (Rs. 8,000 each)
  or OpenWRT routers with LibreMesh firmware (Rs. 4,000 each), powered
  by solar panels with battery backup, providing 200m-1km coverage
  depending on density and terrain
\item
  \textbf{Local Servers}: NAS (Network Attached Storage) or mini-PCs
  (Rs. 25,000 per community hub) running:
...
\textbf{Economic Model:} - Membership fees: Rs. 100/month per household
(Rs. 50 for BPL families) - Volunteer labor: 4 hours/month per household
(valued Rs. 200) for maintenance, training, outreach - Service revenue:
Internet gateway access (Rs. 50/month cost-recovery), premium features
(video conferencing, cloud storage) - External support: Government rural
connectivity subsidies, CSR funding, regional federation technical
assistance - Total budget (100-household village): Rs. 25,000 monthly
revenue vs Rs. 18,000 costs = Rs. 7,000 surplus for expansion/emergency
fund
...
if we reallocate Rs. 10 crore from highway construction to rural
healthcare?'')
...
\item
  ...
  rideshare vehicles equipped with affordable GPS (Rs. 500),
  accelerometers (Rs. 200), and dashboard cameras (Rs. 2,000) providing
  rich multimodal data without the Rs. 50 lakh+ sensor suites of Western
  autonomous vehicles
\item
...
\tightlist
\item
  \textbf{Hardware}: Tablets or smartphones (Rs. 5,000-10,000 subsidy
  for BPL families) with mesh networking capability
\item
  \textbf{Local NAS or Raspberry Pi Server}: Located at Knowledge
  Square, school, or community center (Rs. 15,000-25,000 per hub serving
  50-200 students)
\item
